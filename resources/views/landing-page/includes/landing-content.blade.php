        ...
        <div class="row align-items-start">
            ...
            <div class="col category-item">
                <div class="single-content mt-15 text-center">
                    <div class="content-icon">
                        <div class="content-content">
                            <h4 class="title"><a href="javascript:void(0)">DIY Components</a></h4>
                        </div>
            ...
            <div class="col category-item">
                <div class="single-content mt-15 text-center">
                    <div class="content-icon">
                        <div class="content-content">
                            <h4 class="title"><a href="javascript:void(0)">Graphic Tablet</a></h4>
                        </div>
            ...
            <div class="col category-item">
                <div class="single-content mt-15 text-center">
                    <div class="content-icon">
                        <div class="content-content">
                            <h4 class="title"><a href="javascript:void(0)">Power Banks</a></h4>
                        </div>
            ...
            <div class="col category-item">
                <div class="single-content mt-15 text-center">
                    <div class="content-icon">
                        <div class="content-content">
                            <h4 class="title"><a href="javascript:void(0)">Computer Accessories</a></h4>
                        </div>
