...
<div class="card-body">
    ...
    <form method="POST" action="{{route('dashboard.announcementadd')}} ">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="header" name ="header">
      </div>
      <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Sub_header</label>
        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Sub_Header" name ="sub_header">
      </div>
      <div class="mb-3">
